...
LIFTER_CONFIGS_t LifterConfigs = {
     ...
     .overallStroke      = (u8)20,      /* Overall stroke of the lifter */
     .pulsesPerRevolution = (u16)1600,  /* Pulses per revolution */
     .revolutionStroke   = (u8)2,       /* Revolution stroke of the lifter */
     .speed              = (u8)4,       /* Speed of the lifter */
};