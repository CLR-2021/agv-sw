...
static void NRF24_WriteReg(u8 reg, u8 value) {
...
static void NRF24_WriteRegMulti(u8 reg, u8 *value, u8 len) {
    NRF24_CS_Select();      /* Select nrf24 */
    SPI_SendByte(W_REGISTER | reg);
...
static u8 NRF24_ReadReg(u8 reg) {
    u8 value = 0;
...
static void NRF24_ReadRegMulti(u8 reg, u8 *data, u8 length) {
    u8 value = 0;
...
static void NRF24_Reset(u8 reg) {
    /* Disable nrf24 */
    NRF24_CE_Disable();
    ...
    switch(reg) {
        ...
        default:
            ...
            u8 pipe0[5] = {0xE7, 0xE7, 0xE7, 0xE7, 0xE7};
            NRF24_WriteRegMulti(RX_ADDR_P0, pipe0, 5);
            u8 pipe1[5] = {0xC2, 0xC2, 0xC2, 0xC2, 0xC2};
...
ERROR_STATUS_t NRF24_ReceiveString(u8 *data, u8 length) {
    ERROR_STATUS_t retVal = ERROR_NO;
    u8 volatile fifoStatus = 0;
